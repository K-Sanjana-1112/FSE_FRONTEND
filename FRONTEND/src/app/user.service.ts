...
export class UserService {
  ...
  getLoginType() {
   ...
   createUser(newUser: User): Observable<any> {
    ...
    return this.httpClient.post<any>('http://localhost:3000/api/v1.0/moviebooking/user', newUser);
  }
  ...
  createAdmin(newAdmin: Admin): Observable<any> {
    ...
    return this.httpClient.post<any>('http://localhost:3000/api/v1.0/moviebooking/admin', newAdmin);
  }
 
  userLogin(userCredObj: Object): Observable<any> {
    return this.httpClient.post('http://localhost:3000/api/v1.0/moviebooking/user-login', userCredObj)
  ...
  adminLogin(sellerCredObj: Object): Observable<any> {
    return this.httpClient.post('http://localhost:3000/api/v1.0/moviebooking/admin-login', sellerCredObj)
